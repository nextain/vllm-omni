...
class TestMiniCPMORegistry:
    ...
    def test_thinker_registered(self, omni_models):
        assert "MiniCPMOThinkerForConditionalGeneration" in omni_models

    def test_talker_registered(self, omni_models):
        assert "MiniCPMOTalkerForConditionalGeneration" in omni_models
    ...
    def test_thinker_module_path(self, omni_models):
        mod_folder, mod_relname, cls_name = omni_models["MiniCPMOThinkerForConditionalGeneration"]
        assert mod_folder == "minicpm_o"
        assert mod_relname == "minicpm_o_thinker"
        assert cls_name == "MiniCPMOThinkerForConditionalGeneration"

    def test_talker_module_path(self, omni_models):
        mod_folder, mod_relname, cls_name = omni_models["MiniCPMOTalkerForConditionalGeneration"]
        assert mod_folder == "minicpm_o"
        assert mod_relname == "minicpm_o_talker"
